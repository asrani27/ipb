              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    ...
                    <input type="hidden" class="form-control input-sm" name="skpd_id" value="{{$subkegiatan->skpd_id}}" readonly>
                    <input type="hidden" class="form-control input-sm" name="program_id" value="{{$subkegiatan->kegiatan->program->id}}" readonly>
                    <input type="hidden" class="form-control input-sm" name="kegiatan_id" value="{{$subkegiatan->kegiatan->id}}" readonly>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control input-sm" value="{{$subkegiatan->kegiatan->program->nama}}" readonly>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label">Kegiatan</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control input-sm" value="{{$subkegiatan->kegiatan->nama}}"  readonly>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control input-sm" name="bidang" value="{{$pptk == null ? '' : $pptk->bidang}}">
                  </div>
                </div>
                <div class="form-group">
