...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
            ...
            <tbody>
              ...
              <tr style="font-size:10px;">
                ...
                <td>
                  ...
                  <a href="/pptk/delete_m/{{$item->id}}" onclick="return confirm('Yakin Ingin Di Hapus?');"><i
      ...
      <a href="/pptk/laporanrfk/{{$subkegiatan->id}}/{{$tahun}}/{{$bulan}}/m/add"
        class='btn btn-flat btn-block bg-purple'>TAMBAH</a>
      {{-- <a href="/bidang/laporanrfk-rfk_m/sama-m/{{$subkegiatan->id}}/{{$bulan}}/{{$tahun}}"
        class='btn btn-flat btn-block btn-primary'
        onclick="return confirm('Yakin ingin disamakan dengan bulan sebelumnya?');">SAMA DENGAN SEBELUMNYA</a> --}}
    </div>
  </div>
</section>
