    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <form class="form-horizontal" method="post"
          action="/bidang/laporanrfk-rfk_v/tambah-v/{{$subkegiatan->id}}/{{$bulan}}" enctype="multipart/form-data">
          @csrf
          <div class="box-body">
  ...
  <table>
    <tr>
      ...
      <td style="text-align: center">
        ...
        <a href="/bidang/laporanrfk-rfk_v/delete/{{$item->id}}" onclick="return confirm('Yakin Ingin Di Hapus?');"><i
