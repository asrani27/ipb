...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
            ...
            <tbody>
              ...
              <tr style="font-size:10px;">
                ...
                <td>
                  ...
                  <a href="/bidang/laporanrfk-rfk_st/delete/{{$item->id}}"
                    onclick="return confirm('Yakin Ingin Di Hapus?');"><i class="fa fa-trash"></i></a>
                </td>
              </tr>
              @endforeach
      ...
      <a href="/bidang/laporanrfk-rfk_st/tambah-st/{{$subkegiatan->id}}/{{$bulan}}"
