      ...
      <div class="box box-primary">
        ...
        <div class="box-body text-sm">
          <dl>
            ...
            <dt>Sub Kegiatan</dt>
            <dd>{{$subkegiatan->kode}} <br /> {{$subkegiatan->nama}}</dd><br />
    ...
    <div class="col-md-9">
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <div class="box-tools">
            <a href="/pptk/subkegiatan/uraian/{{$subkegiatan->id}}" class="btn btn-sm bg-gray btn-flat"><i
                class="fa fa-arrow-left"></i> Kembali</a>
          </div>
        </div>
        <!-- /.box-header -->
        <form class="form-horizontal" method="POST" action="/pptk/angkas/{{$uraian->id}}">
          @csrf
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control"
                  value="{{number_format($uraian->p_januari_keuangan, 0, ',', '.')}}" name="januari_keuangan"
                  oninput="formatInput(this)" id="nilaijanuari">
              </div>
              <div class="col-sm-5">
                <input type="text" class="form-control" value="{{$uraian->p_januari_fisik}}" name="januari_fisik"
                  id="fisikjanuari" oninput="calculateTotal()">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control"
                  value="{{number_format($uraian->p_februari_keuangan, 0, ',', '.')}}" name="februari_keuangan"
                  oninput="formatInput(this)" id="nilaifebruari">
              </div>
              <div class="col-sm-5">
                <input type="text" class="form-control" value="{{$uraian->p_februari_fisik}}" name="februari_fisik"
                  id="fisikfebruari" oninput="calculateTotal()">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control"
                  value="{{number_format($uraian->p_maret_keuangan, 0, ',', '.')}}" name="maret_keuangan"
                  oninput="formatInput(this)" id="nilaimaret">
              </div>
              <div class="col-sm-5">
                <input type="text" class="form-control" value="{{$uraian->p_maret_fisik}}" name="maret_fisik"
                  id="fisikmaret" oninput="calculateTotal()">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control"
                  value="{{number_format($uraian->p_april_keuangan, 0, ',', '.')}}" name="april_keuangan"
                  oninput="formatInput(this)" id="nilaiapril">
              </div>
              <div class="col-sm-5">
                <input type="text" class="form-control" value="{{$uraian->p_april_fisik}}" name="april_fisik"
                  id="fisikapril" oninput="calculateTotal()">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Mei</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" value="{{number_format($uraian->p_mei_keuangan, 0, ',', '.')}}"
                  name="mei_keuangan" oninput="formatInput(this)" id="nilaimei">
              </div>
              <div class="col-sm-5">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" value="{{number_format($uraian->p_juni_keuangan, 0, ',', '.')}}"
                  name="juni_keuangan" oninput="formatInput(this)" id="nilaijuni">
              </div>
              <div class="col-sm-5">
                <input type="text" class="form-control" value="{{$uraian->p_juni_fisik}}" name="juni_fisik"
                  id="fisikjuni" oninput="calculateTotal()">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Juli</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" value="{{number_format($uraian->p_juli_keuangan, 0, ',', '.')}}"
                  name="juli_keuangan" oninput="formatInput(this)" id="nilaijuli">
              </div>
              <div class="col-sm-5">
                <input type="text" class="form-control" value="{{$uraian->p_juli_fisik}}" name="juli_fisik"
                  id="fisikjuli" oninput="calculateTotal()">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" name="agustus_keuangan"
                  value="{{number_format($uraian->p_agustus_keuangan, 0, ',', '.')}}" oninput="formatInput(this)"
                  id="nilaiagustus">
              </div>
              <div class="col-sm-5">
                <input type="text" class="form-control" value="{{$uraian->p_agustus_fisik}}" name="agustus_fisik"
                  id="fisikagustus" oninput="calculateTotal()">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" name="september_keuangan"
                  value="{{number_format($uraian->p_september_keuangan, 0, ',', '.')}}" oninput="formatInput(this)"
                  id="nilaiseptember">
              </div>
              <div class="col-sm-5">
                <input type="text" class="form-control" value="{{$uraian->p_september_fisik}}" name="september_fisik"
                  id="fisikseptember" oninput="calculateTotal()">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" name="oktober_keuangan"
                  value="{{number_format($uraian->p_oktober_keuangan, 0, ',', '.')}}" oninput="formatInput(this)"
                  id="nilaioktober">
              </div>
              <div class="col-sm-5">
                <input type="text" class="form-control" value="{{$uraian->p_oktober_fisik}}" name="oktober_fisik"
                  id="fisikoktober" oninput="calculateTotal()">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" name="november_keuangan"
                  value="{{number_format($uraian->p_november_keuangan, 0, ',', '.')}}" oninput="formatInput(this)"
                  id="nilainovember">
              </div>
              <div class="col-sm-5">
                <input type="text" class="form-control" value="{{$uraian->p_november_fisik}}" name="november_fisik"
                  id="fisiknovember" oninput="calculateTotal()">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" name="desember_keuangan"
                  value="{{number_format($uraian->p_desember_keuangan, 0, ',', '.')}}" oninput="formatInput(this)"
                  id="nilaidesember">
              </div>
              <div class="col-sm-5">
                <input type="text" class="form-control" value="{{$uraian->p_desember_fisik}}" name="desember_fisik"
                  id="fisikdesember" oninput="calculateTotal()">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" value="{{number_format($uraian->dpa, 0, ',', '.')}}"
                  name="sisa_dpa" readonly id="sisa_dpa">
                Pastikan sisa DPA 0
              </div>
              <div class="col-sm-5">
