...
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <form class="form-horizontal" method="post" action="/pemohon/{{$id}}/berkas/krk_kkpr/create">
            @csrf
            <div class="box-body">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label"></label>
                    <div class="col-sm-10">
                    Dalam hal ini bertindak dan atas nama :<input type="text" class="form-control" name="atas_nama" placeholder="Atas Nama">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">Kelurahan</label>
                    <div class="col-sm-10">
                    <input type="text" class="form-control" name="kelurahan2" placeholder="Kelurahan">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">Kecamatan</label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" name="jenis_peruntukan" placeholder="Jenis Peruntukan">
