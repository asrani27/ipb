...
class SuperadminController extends Controller
{
    ...
    public function export()
    {
        ...
        foreach ($disdik as $key => $item_disdik) {
            ...
            $spreadsheet->getSheetByName('1 Disdik')->setCellValue('R' . $disdikRow, '=IF(P' . $disdikRow . '=0,0,N' . $disdikRow . '/P' . $disdikRow . '*100)');
            $disdikRow++;
        }
        ...
        if ($disdik->sum('rencana') == 0) {
            $spreadsheet->getSheetByName('1 Disdik')->setCellValue('K' . $disdik->count() + 11, '0');
        } else {
            $spreadsheet->getSheetByName('1 Disdik')->setCellValue('K' . $disdik->count() + 11, '=H' . $disdik->count() + 11 . '/E' . $disdik->count() + 11 . '*100');
        }
        ...
        if ($disdik->sum('rencana_fisik') == 0) {
            $spreadsheet->getSheetByName('1 Disdik')->setCellValue('R' . $disdik->count() + 11, '0');
        } else {
            $spreadsheet->getSheetByName('1 Disdik')->setCellValue('R' . $disdik->count() + 11, '=P' . $disdik->count() + 11 . '/N' . $disdik->count() + 11 . '*100');
        }
        //dd('ds');
        // // DINKES
