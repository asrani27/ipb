    ...
    public function export()
    {
        ...
        if ($bagpbg->count() != 0) {
            foreach ($bagpbg as $key => $item) {
                ...
                $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('G' . $bagpbgRow, '=F' . $bagpbgRow . '*D' . $bagpbgRow . '/100');
                $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('H' . $bagpbgRow, $item->realisasi);
                $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('I' . $bagpbgRow, '=H' . $bagpbgRow . '/C' . $bagpbgRow . '*100');
                $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('J' . $bagpbgRow, '=I' . $bagpbgRow . '*D' . $bagpbgRow . '/100');
                $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('K' . $bagpbgRow, '=IF(E' . $bagpbgRow . '=0,0,H' . $bagpbgRow . '/E' . $bagpbgRow . '*100)');
                $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('L' . $bagpbgRow, '=J' . $bagpbgRow . '-G' . $bagpbgRow);
                $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('M' . $bagpbgRow, '=C' . $bagpbgRow . '-H' . $bagpbgRow);
                $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('N' . $bagpbgRow, $item->rencana_fisik);
                $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('O' . $bagpbgRow, '=N' . $bagpbgRow . '*D' . $bagpbgRow . '/100');
                $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('P' . $bagpbgRow, $item->realisasi_fisik);
                $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('Q' . $bagpbgRow, '=P' . $bagpbgRow . '*D' . $bagpbgRow . '/100');
                $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('R' . $bagpbgRow, '=IF(N' . $bagpbgRow . '=0,0,P' . $bagpbgRow . '/N' . $bagpbgRow . '*100)');
                $bagpbgRow++;
            }
            $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('B' . $bagpbg->count() + 11, 'TOTALNYA');
            $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('C' . $bagpbg->count() + 11, '=SUM(C11:C' . $bagpbg->count() + 10 . ')');
            $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('D' . $bagpbg->count() + 11, '=SUM(D11:D' . $bagpbg->count() + 10 . ')');
            $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('E' . $bagpbg->count() + 11, '=SUM(E11:E' . $bagpbg->count() + 10 . ')');
            $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('F' . $bagpbg->count() + 11, '=SUM(G11:G' . $bagpbg->count() + 10 . ')');
            $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('G' . $bagpbg->count() + 11, '=SUM(G11:G' . $bagpbg->count() + 10 . ')');
            $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('H' . $bagpbg->count() + 11, '=SUM(H11:H' . $bagpbg->count() + 10 . ')');
            $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('I' . $bagpbg->count() + 11, '=SUM(J11:J' . $bagpbg->count() + 10 . ')');
            $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('J' . $bagpbg->count() + 11, '=SUM(J11:J' . $bagpbg->count() + 10 . ')');
            $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('K' . $bagpbg->count() + 11, '=IF(E' . $bagpbg->count() + 11 . '=0,0,H' . $bagpbg->count() + 11 . '/E' . $bagpbg->count() + 11 . '*100)');
            $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('L' . $bagpbg->count() + 11, '=J' . $bagpbg->count() + 11 . '-G' .  $bagpbg->count() + 11);
            $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('M' . $bagpbg->count() + 11, '=C' . $bagpbg->count() + 11 . '-H' .  $bagpbg->count() + 11);
            $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('N' . $bagpbg->count() + 11, '=SUM(O11:O' . $bagpbg->count() + 10 . ')');
            $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('O' . $bagpbg->count() + 11, '=SUM(O11:O' . $bagpbg->count() + 10 . ')');
            $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('P' . $bagpbg->count() + 11, '=SUM(Q11:Q' . $bagpbg->count() + 10 . ')');
            $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('Q' . $bagpbg->count() + 11, '=SUM(Q11:Q' . $bagpbg->count() + 10 . ')');
            $spreadsheet->getSheetByName('28 BAGPBG')->setCellValue('R' . $bagpbg->count() + 11, '=IF(N' . $bagpbg->count() + 11 . '=0,0,P' . $bagpbg->count() + 11 . '/N' . $bagpbg->count() + 11 . '*100)');
        }
        // bagprokopim
